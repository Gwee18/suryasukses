    ...
    <div class="container prelative">
        <div class="row">
            ...
            <div class="col-md-9 rights_cont_def">
                ...
                <span class="dates"><small><i class="fa fa-calendar"></i> 02 July 2020</small></span>
                <div class="clear clearfix"></div>
                <div class="py-3"></div>
                ...
                <div class="row feature-data mb-0 mt-0">
                    <div class="col-md-12">
                        ...
                        <div class="contents_det_blog">
                            ...
                            <div class="row">
                                <div class="col">
                                    <p><a href="{{ route('news.detail19') }}"><i class="fa fa-chevron-left"></i> Back</a></p>
                                </div>
                                <div class="col">
                                    <p class="text-center">
                                ...
                                <div class="col text-end">
                                    <p class="text-end"><a href="{{ route('news.detail16') }}">Next <i class="fa fa-chevron-right"></i></a></p>
                                </div>
                            </div>
                            <div class="clear"></div>
                        </div>
