...
@section('title', 'Filtration Market - Suryasukses Group')
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="#" style="cursor: default;">Market</a></li> 
                                        <li class="breadcrumb-item active" aria-current="page"><a href="#">Filtration</a></li>
                                    </ol>
            </nav>
        </div>
        <div class="col-md-15">
...
<ul class="list-unstyled lefts_submenu_product">
		...
		<li class="dropdown active"><a href="{{ route('markets.filtration') }}">Filtration</a>
	</li>
...
<div class="featured_car_detail">
                <div id="carouselEx_gallery" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner">
                     <div class="carousel-item active">
                       <img class="img img-fluid w-100" src="https://suryasukses.com/images/category/36daa-ill-filtration.jpg" alt="filtration">
                    </div>
                  </div>
                </div>
            </div>
                ...
                <div class="row default-data">
                    ...
                    <div class="box-content">
                        <div class="image">
                            <img class="img img-fluid w-100"src="https://suryasukses.com/images/brand/8560a-air-filtration.jpg" alt="">
                            <a href="#">
                            </a>
                        </div>
                        <div class="title">
                        ...
                        <div class="subtitle">
                            <p>Surya Sukses Group’s meltblown materials serve a wide variety of air applications from room air purifier to facemasks to cabin air filtration.</p>                        </div>
                                                <div class="klik">
                    ...
                    <div class="box-content">
                        <div class="image">
                            <img class="img img-fluid w-100"src="https://suryasukses.com/images/brand/b51b4-liquid-filtration.jpg" alt="">
                            <a href="#">
                            </a>
                        </div>
                        <div class="title">
                        ...
                        <div class="subtitle">
                            <p>Surya Sukses Group’s spunbond materials are suitable for filter manufacturers factory for their high strength, uniformity, and cleanliness in pleated filter cartridges. The polypropylene materials allows for a wide range of temperature and chemical compatibility.</p>                        </div>
                                                <div class="klik">
                        <a class="btn btn-danger" href="{{ route('contact') }}"><p>Inquire</p></a>
                        </div>
                                            </div>
