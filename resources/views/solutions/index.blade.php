                ...
                <main class="studio-body">
                    ...
                    <div class="studio-content">
                        <div class="studio-banner">
                            <img src="{{ asset('assets/images/' . ($studio->hero_image ?? ($page->content['image_1'] ?? 'solutions/aa68c28011sbl-sap (1) (1).jpg'))) }}" alt="{{ $page->title ?? 'Suryasukses Studio' }}" class="studio-image">
                        </div>

                        <div class="studio-description">
                            {!! nl2br(e($studio->main_text ?? ($page->content['main_text'] ?? "Whether you’re looking for a specific cap or or designing a revolutionary bottle/cup shape, our teams will work together to develop a product your consumers are sure to enjoy, guaranteed by our many years of experience and well-established networks around the world.\n\nOur decoration options includes:\n- Custom design products\n- Offset printing on Cup\n- Emboss cap\n- Emboss bottle\n- Print logo on Houseware products\n\nContact us and discuss your project with us now."))) !!}
                        </div>
                        
                        <div class="whatsapp pt-2">
                            <h5>Whatsapp <a target="_blank" href="{{ $studio->whatsapp_link ?? ($page->content['whatsapp_link'] ?? 'http://wa.me/6285777303030') }}"><img src="{{ asset('assets/images/WA-Logo-copy-2.png') }}" alt=""> {{ $studio->whatsapp ?? ($page->content['whatsapp'] ?? '+62 857 7730 3030') }}</a></h5>
                        </div>
                    </div>
                </main>
